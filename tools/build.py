...
{related}
  ...
  <aside class="chan-cta" aria-label="Telegram-канал" style="max-width:820px;margin:14px auto 4px;display:flex;flex-wrap:wrap;align-items:center;gap:14px 20px;background:var(--card);border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow);padding:20px 24px">
    ...
    <a href="https://t.me/adv_osadko" target="_blank" rel="noopener" onclick="window.osadkoTrack&&osadkoTrack('subscribe_click',{channel:'telegram'})" style="flex:0 0 auto;display:inline-flex;align-items:center;gap:8px;background:#0088cc;color:#fff;font-weight:700;text-decoration:none;padding:12px 22px;border-radius:12px">Підписатися</a>
  </aside>
</main>
